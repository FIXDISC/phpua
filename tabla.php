...
<table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-color:#000">
  <tr class="tit_tabla">
    ...
    <td bgcolor="#252324" style="font-size:12px">INCIDENTES</td>
    <td bgcolor="#252324" style="font-size:12px">FINALIZADOS</td>
    <td bgcolor="#252324" style="font-size:12px">PENDIENTES</td>
    <td bgcolor="#252324" style="font-size:12px">EN CURSO</td>
  </tr>
  <tr>
