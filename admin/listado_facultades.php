...
$oFacultades = new cFacultades;
$consulta = $oFacultades->consultar($ord,$dire);
...
if ($num_rows!=0){ ?>
	<form name='form1' id='form1' method='post'>
      <div id='ta_agregar'><table cellpadding='0' cellspacing='0' width='100%'>
	     ...
	     <tr>
	       <td width="87" height="30" bgcolor="#678916" style="text-align:center; cursor:pointer" onclick="javascript:muestra_a_facultad();">AGREGAR</td>
		...
		<table width="100%" border="0" cellpadding='0' cellspacing='0'>
	          <tr class="tit_tabla">
	            ...
	            <td style="text-align:left;border:solid #000 1px;" onclick="javascript:cargarPag('listado_Campus1.php','datos1','<?php echo $col ?>','nombre','<?php echo $dire ?>');" ><span class="span_fact" style="float:left;">&nbsp;NOMBRE CORTO</span><span style='float:right;margin:4px;'><img src='img/<?php echo $flecha2 ?>' alt="" name='flecha2' width='8' height='8' id='flecha7' /></span></td>
...
<?php }else{ ?>
	<form name='form1' id='form1' method='post'>
	   <div id='ta_agregar'><table cellpadding='0' cellspacing='0' width='100%'>
	     ...
	     <tr>
	       <td width="87" height="30" bgcolor="#678916" style="text-align:center; cursor:pointer" onclick="javascript:muestra_a_facultad();">AGERGAR</td>
	       <td bgcolor="#333333">&nbsp;</td>
         </tr>
	...
	<div align='center' style="background-color:#333"><br>
	  NO EXISTEN FACULTADES EN EL SISTEMA<br>
	<br>
<br></div><br>	
<?php } ?>