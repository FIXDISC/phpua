...
$oArea = new cAreas;
$consulta = $oArea->consultar($ord,$dire);
...
if ($num_rows!=0){ ?>
	<form name='form1' id='form1' method='post'>
      <div id='ta_agregar'><table cellpadding='0' cellspacing='0' width='100%'>
	     ...
	     <tr>
	       <td width="87" height="30" bgcolor="#678916" style="text-align:center; cursor:pointer" onclick="javascript:muestra_a_area();cargarContenido('admin/carga_sel_campus.php','con_campus');cargarContenido('admin/carga_sel_dependencia.php','con_dependencia');cargarContenido('admin/carga_sel_tipoarea.php','con_tipo');		
">AGREGAR</td>
		...
		<table width="100%" border="0" cellpadding='0' cellspacing='0'>
           ...
           <div id='agregar'>
			   <tr height='0'>
				  ...
				  <td bgcolor="#666" style="text-align:left"><div id='con_dependencia'></div></td>
...
?>
		          <tr id='line<?php echo $row['id'] ?>' onMouseOver="on_ove('line<?php echo $row['id'] ?>')" onMouseOut="on_out('line<?php echo $row['id'] ?>')" class="cont_tabla">
		            ...
		            <td style="text-align:left;border:solid #000 1px;"><div id='con_nombre_corto<?php echo $row['id'] ?>'>&nbsp;<?php echo ($row['nombre_corto1']) ?></div></td>
