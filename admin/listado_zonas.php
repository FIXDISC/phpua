...
$oZona = new cZonas;
$consulta = $oZona->consultar($ord,$dire);
...
if ($num_rows!=0){ ?>
	<form name='form1' id='form1' method='post'>
      <div id='ta_agregar'><table cellpadding='0' cellspacing='0' width='100%'>
	     ...
	     <tr>
	       <td width="87" height="30" bgcolor="#678916" style="text-align:center; cursor:pointer" onclick="javascript:muestra_a_zona();cargarContenido('admin/carga_sel_areas.php','con_area');">AGREGAR</td>
		...
		<table width="100%" border="0" cellpadding='0' cellspacing='0'>
	          <tr class="tit_tabla">
	            ...
	            <td style="text-align:left;border:solid #000 1px;" onclick="javascript:cargarPag('listado_Campus1.php','datos1','<?php echo $col ?>','nombre','<?php echo $dire ?>');" ><span class='span_fact' style='float:left;'>&nbsp;AREA </span><span style="float:right;margin:4px;"><img src='img/<?php echo $flecha2 ?>' alt="" name='flecha2' width='8' height='8' id='flecha8' /></span></td>
...
<?php	while($row = mysql_fetch_array($consulta)){	 
			$oArea = new cAreas;
			$consulta1 = $oArea->consultar_id($row['id_area']);
...
<?php }else{ ?>
	<form name='form1' id='form1' method='post'>
	   <div id='ta_agregar'><table cellpadding='0' cellspacing='0' width='100%'>
	     ...
	     <tr>
	       <td width="87" height="30" bgcolor="#678916" style="text-align:center; cursor:pointer" onclick="javascript:muestra_a_zona();cargarContenido('admin/carga_sel_areas.php','con_area');">AGERGAR</td>
	       <td bgcolor="#333333">&nbsp;</td>
         </tr>
		...
		<table width="100%" border="0" cellpadding='0' cellspacing='0'>
              <tr class="tit_tabla">
	             ...
	             <td style="text-align:left;border:solid #000 1px;" onclick="javascript:cargarPag('listado_Campus1.php','datos1','<?php echo $col ?>','nombre','<?php echo $dire ?>');" ><span class='span_fact' style='float:left;'>&nbsp;AREA </span><span style="float:right;margin:4px;"><img src='img/<?php echo $flecha2 ?>' alt="" name='flecha2' width='8' height='8' id='flecha10' /></span></td>
                <td width="80"><div class='span_fact1'>&nbsp;MODIFICAR</div></td>
                <td width="80"><div class='span_fact1'>&nbsp;ELIMINAR</div></td>
          </tr>
			   <tr id='ta_campus' height='0' class="cont_tabla">
			     ...
			     <td style="text-align:left;border:solid #000 1px;" bgcolor="#666666"><div id='con_area'></div></td>
	...
	<div align='center' style="background-color:#333"><br>
	  NO EXISTEN AREAS EN EL SISTEMA<br>
	<br>
<br></div><br>	
<?php } ?>