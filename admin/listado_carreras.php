...
$consulta = $oCarrera->consultar($ord,$dire);

$oCarreras = new cCarreras;
$consulta1 = $oCarreras->consultar($ord,$dire);
...
if ($num_rows!=0){ ?>
	<form name='form1' id='form1' method='post'>
      <div id='ta_agregar'><table cellpadding='0' cellspacing='0' width='100%'>
	     ...
	     <tr>
	       <td width="87" height="30" bgcolor="#678916" style="text-align:center; cursor:pointer" onclick="javascript:muestra_a_carrera();cargarContenido('admin/carga_sel_facultad.php','con_facultad');">AGREGAR</td>
		...
		<table width="100%" border="0" cellpadding='0' cellspacing='0'>
	          <tr class="tit_tabla">
	            <td width="35" style="text-align:center;border:solid #000 1px;" onclick="javascript:cargarPag('listado_carrera1.php','datos1','<?php echo $col ?>','rut','<?php echo $dire ?>');">&nbsp;ID<img src='img/<?php echo $flecha1 ?>' name='flecha1' id='flecha1' width='8' height='8'></td>
	            <td width="230" style="text-align:left;border:solid #000 1px;" onclick="javascript:cargarPag('listado_carrera1.php','datos1','<?php echo $col ?>','nombre','<?php echo $dire ?>');" ><span class='span_fact' style='float:left;'>&nbsp;NOMBRE </span><span style='float:right;margin:4px;'><img src='img/<?php echo $flecha2 ?>' name='flecha2' id='flecha2' width='8' height='8'></span></td>
	            <td width="150" style="text-align:left;border:solid #000 1px;" onclick="javascript:cargarPag('listado_carrera1.php','datos1','<?php echo $col ?>','nombre','<?php echo $dire ?>');" ><span class="span_fact" style="float:left;">&nbsp;NOMBRE CORTO</span><span style='float:right;margin:4px;'><img src='img/<?php echo $flecha2 ?>' alt="" name='flecha2' width='8' height='8' id='flecha7' /></span></td>
	            <td style="text-align:left;border:solid #000 1px;" onclick="javascript:cargarPag('listado_carrera1.php','datos1','<?php echo $col ?>','nombre','<?php echo $dire ?>');" ><span class='span_fact' style='float:left;'>FACULTAD </span><span style="float:right;margin:4px;"><img src='img/<?php echo $flecha2 ?>' alt="" name='flecha2' width='8' height='8' id='flecha8' /></span></td>
           ...
           <div id='agregar'>
			   <tr height='0'>
				  ...
				  <td bgcolor="#666" style="text-align:left"><div id='con_facultad'></div></td>
...
<?php }else{ ?>
	<form name='form1' id='form1' method='post'>
	   <div id='ta_agregar'><table cellpadding='0' cellspacing='0' width='100%'>
	     <tr>
	       <td colspan="2" style="text-align:center; cursor:pointer" onclick='javascript:muestra_a_carrera();'>&nbsp;</td>
         </tr>
	     <tr>
	       <td width="87" height="30" bgcolor="#678916" style="text-align:center; cursor:pointer" onclick="javascript:muestra_a_carrera();cargarContenido('admin/carga_sel_facultad.php','con_facultad');">AGERGAR</td>
	       <td bgcolor="#333333">&nbsp;</td>
         </tr>
		...
		<table width="100%" border="0" cellpadding='0' cellspacing='0'>
              <tr class="tit_tabla">
	             <td style="text-align:center;border:solid #000 1px;" onclick="javascript:cargarPag('listado_carrera1.php','datos1','<?php echo $col ?>','rut','<?php echo $dire ?>');">&nbsp;ID<img src='img/<?php echo $flecha1 ?>' alt="" name='flecha1' width='8' height='8' id='flecha4' /></td>
			   ...
			   <tr id='ta_carrera' height='0' class="cont_tabla">
			     ...
			     <td style="text-align:left;border:solid #000 1px;" bgcolor="#666666"><div id='con_facultad'></div></td>
	...
	<div align='center' style="background-color:#333"><br>
	  NO EXISTEN CARRERAS EN EL SISTEMA<br>
	<br>
<br></div><br>	
<?php } ?>